  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Wettkämpfe</h1>
        <button
          onClick={() => { setShowAdd(true); setEditComp(null) }}
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex gap-1 shrink-0">
                    <button
                      onClick={(e) => { e.stopPropagation(); setEditComp(c) }}
      ...
      {deleteId && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4"
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-sm"
            ...
            <h3 className="font-semibold text-gray-800 mb-2">Wettkampf löschen?</h3>
            <p className="text-sm text-gray-500 mb-4">
              Alle Läufe und Medien dieses Wettkampfs werden ebenfalls gelöscht.
            </p>
